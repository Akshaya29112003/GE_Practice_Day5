...
public class AddressBookMain {
    ...
    public static void main(String[] args) {
        ...
        display_Contacts display = new display_Contacts();
        Delete_Contact delete = new Delete_Contact();
        ...
        while (true) {
            ...
            switch (choice) {
                case 1: // Add contact
                    ...
                    ContactPerson newContact = new ContactPerson(fname, lname, address, city, state, zip, phone, email);
